...
public class MagicRedStone extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicRedStone"));
    ...
    public static final String ID = TheWitch.makeID("MagicRedStone");
