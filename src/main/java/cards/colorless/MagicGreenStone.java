...
public class MagicGreenStone extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicGreenStone"));
    ...
    public static final String ID = TheWitch.makeID("MagicGreenStone");
