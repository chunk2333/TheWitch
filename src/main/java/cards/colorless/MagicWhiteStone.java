...
public class MagicWhiteStone extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicWhiteStone"));
    ...
    public static final String ID = TheWitch.makeID("MagicWhiteStone");
