...
public class MagicYellowStone extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicYellowStone"));
    ...
    public static final String ID = TheWitch.makeID("MagicYellowStone");
