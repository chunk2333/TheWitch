...
public class Penetrate extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("Penetrate"));
    ...
    public static final String ID = TheWitch.makeID("Penetrate");
