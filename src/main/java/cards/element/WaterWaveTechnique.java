...
public class WaterWaveTechnique extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("WaterWaveTechnique"));
    ...
    public static final String ID = TheWitch.makeID("WaterWaveTechnique");
