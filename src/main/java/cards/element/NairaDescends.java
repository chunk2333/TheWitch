...
public class NairaDescends extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("NairaDescends"));
    ...
    public static final String ID = TheWitch.makeID("NairaDescends");
