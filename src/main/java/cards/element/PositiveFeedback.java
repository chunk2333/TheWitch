...
public class PositiveFeedback extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("PositiveFeedback"));
    ...
    public static final String ID = TheWitch.makeID("PositiveFeedback");
