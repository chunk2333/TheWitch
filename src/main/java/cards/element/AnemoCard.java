...
public class AnemoCard extends CustomCard{
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("AnemoCard"));
    ...
    public static final String ID = TheWitch.makeID("AnemoCard");
