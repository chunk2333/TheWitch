...
public class InflammationOfTheWheel extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("InflammationOfTheWheel"));
    ...
    public static final String ID = TheWitch.makeID("InflammationOfTheWheel");
