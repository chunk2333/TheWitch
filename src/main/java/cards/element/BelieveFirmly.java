...
public class BelieveFirmly extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("BelieveFirmly"));
    ...
    public static final String ID = TheWitch.makeID("BelieveFirmly");
