...
public class Annihilate extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("Annihilate"));
    ...
    public static final String ID = TheWitch.makeID("Annihilate");
