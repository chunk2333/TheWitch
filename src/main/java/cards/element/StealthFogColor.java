...
public class StealthFogColor extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("StealthFogColor"));
    ...
    public static final String ID = TheWitch.makeID("StealthFogColor");
