...
public class ReconstructEverything extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("ReconstructEverything"));
    ...
    public static final String ID = TheWitch.makeID("ReconstructEverything");
