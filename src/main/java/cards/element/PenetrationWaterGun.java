...
public class PenetrationWaterGun extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("PenetrationWaterGun"));
    ...
    public static final String ID = TheWitch.makeID("PenetrationWaterGun");
