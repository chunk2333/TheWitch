...
public class BladeOfWind extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("BladeOfWind"));
    ...
    public static final String ID = TheWitch.makeID("BladeOfWind");
