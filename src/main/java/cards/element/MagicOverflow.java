...
public class MagicOverflow extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicOverflow"));
    ...
    public static final String ID = TheWitch.makeID("MagicOverflow");
