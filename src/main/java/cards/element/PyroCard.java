...
public class PyroCard extends CustomCard{
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("PyroCard"));
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "img/cards/witch/PyroCard.png";
    private static final int COST = 0;
    public static final String ID = TheWitch.makeID("PyroCard");
    public PyroCard() {
