...
public class SpiritualDomination extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("SpiritualDomination"));
    ...
    public static final String ID = TheWitch.makeID("SpiritualDomination");
