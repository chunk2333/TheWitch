...
public class MagicFeedback extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicFeedback"));
    ...
    public static final String ID = TheWitch.makeID("MagicFeedback");
