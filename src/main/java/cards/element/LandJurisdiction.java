...
public class LandJurisdiction extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("LandJurisdiction"));
    ...
    public static final String ID = TheWitch.makeID("LandJurisdiction");
