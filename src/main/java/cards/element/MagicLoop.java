...
public class MagicLoop extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicLoop"));
    ...
    public static final String ID = TheWitch.makeID("MagicLoop");
