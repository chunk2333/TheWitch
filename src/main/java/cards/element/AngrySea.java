...
public class AngrySea extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("AngrySea"));
    ...
    public static final String ID = TheWitch.makeID("AngrySea");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        int HydroCardNum = YiBaHelper.getTagsCardNum(TheWitch.HYDRO);
