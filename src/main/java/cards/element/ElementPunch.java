...
public class ElementPunch extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("ElementPunch"));
    ...
    public static final String ID = TheWitch.makeID("ElementPunch");
