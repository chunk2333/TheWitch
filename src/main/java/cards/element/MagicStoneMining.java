...
public class MagicStoneMining extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicStoneMining"));
    ...
    public static final String ID =  TheWitch.makeID("MagicStoneMining");
