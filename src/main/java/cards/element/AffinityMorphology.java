...
public class AffinityMorphology extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("AffinityMorphology"));
    ...
    public static final String ID = TheWitch.makeID("AffinityMorphology");
