...
public class TransformingFeatherIntoSpirit extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("TransformingFeatherIntoSpirit"));
    ...
    public static final String ID = TheWitch.makeID("TransformingFeatherIntoSpirit");
