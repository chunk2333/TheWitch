...
public class MeleeAttack extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MeleeAttack"));
    ...
    public static final String ID = TheWitch.makeID("MeleeAttack");
