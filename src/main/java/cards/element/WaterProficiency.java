...
public class WaterProficiency extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("WaterProficiency"));
    ...
    public static final String ID = TheWitch.makeID("WaterProficiency");
