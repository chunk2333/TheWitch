...
public class ElementalRefining extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("ElementalRefining"));
    ...
    public static final String ID = TheWitch.makeID("ElementalRefining");
