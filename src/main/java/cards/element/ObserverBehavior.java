...
public class ObserverBehavior extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("ObserverBehavior"));
    ...
    public static final String ID = TheWitch.makeID("ObserverBehavior");
