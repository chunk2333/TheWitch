...
public class LookingGlass extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("LookingGlass"));
    ...
    public static final String ID = TheWitch.makeID("LookingGlass");
