...
public class FlamingHoard extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("FlamingHoard"));
    ...
    public static final String ID = TheWitch.makeID("FlamingHoard");
