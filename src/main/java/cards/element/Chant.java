...
public class Chant extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("Chant"));
    ...
    public static final String ID = TheWitch.makeID("Chant");
