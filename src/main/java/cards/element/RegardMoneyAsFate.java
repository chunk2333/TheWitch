...
public class RegardMoneyAsFate extends CustomCard {
    //吃不到敏捷和脆弱
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("RegardMoneyAsFate"));

    public static final String NAME = cardStrings.NAME;

    public static final String DESCRIPTION = cardStrings.DESCRIPTION;

    public static final String ID = TheWitch.makeID("RegardMoneyAsFate");
