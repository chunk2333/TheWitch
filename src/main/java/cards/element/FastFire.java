...
public class FastFire extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("FastFire"));
    ...
    public static final String ID = TheWitch.makeID("FastFire");
