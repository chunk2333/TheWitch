...
public class SoftWaterShield extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("SoftWaterShield"));
    ...
    public static final String ID = TheWitch.makeID("SoftWaterShield");
