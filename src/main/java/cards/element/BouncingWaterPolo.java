...
public class BouncingWaterPolo extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("BouncingWaterPolo"));
    ...
    public static final String ID = TheWitch.makeID("BouncingWaterPolo");
