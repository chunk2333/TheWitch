...
public class CrazyHurricaneCut extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("CrazyHurricaneCut"));
    ...
    public static final String ID = TheWitch.makeID("CrazyHurricaneCut");
