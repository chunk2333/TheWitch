...
public class SlashAndBurn extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("SlashAndBurn"));
    ...
    public static final String ID = TheWitch.makeID("SlashAndBurn");
