...
public class PleaseKeepBack extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("PleaseKeepBack"));
    ...
    public static final String ID = TheWitch.makeID("PleaseKeepBack");
