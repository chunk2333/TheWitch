...
public class BeAlmostWipedOut extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("BeAlmostWipedOut"));

    public static final String NAME = cardStrings.NAME;

    public static final String DESCRIPTION = cardStrings.DESCRIPTION;

    public static final String ID = TheWitch.makeID("BeAlmostWipedOut");
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        ...
        for (AbstractCard c : p.hand.group) {
            ...
            if (c.hasTag(TheWitch.ELEMENT) && c != this) {
                canUse = false;
                this.cantUseMessage = (CardCrawlGame.languagePack.getUIString(TheWitch.makeID("isHasElementCard"))).TEXT[0];
            }
        }
        return canUse;
    }
