...
public class MagicPress extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("MagicPress"));
    ...
    public static final String ID = TheWitch.makeID("MagicPress");
