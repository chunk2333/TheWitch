...
public class AdvancedTrainingTechniques extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("AdvancedTrainingTechniques"));
    ...
    public static final String ID = TheWitch.makeID("AdvancedTrainingTechniques");
