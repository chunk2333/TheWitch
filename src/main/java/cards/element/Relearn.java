...
public class Relearn extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("Relearn"));
    ...
    public static final String ID = TheWitch.makeID("Relearn");
