...
public class ThousandCragMyriadRavine extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(TheWitch.makeID("ThousandCragMyriadRavine"));
    ...
    public static final String ID = TheWitch.makeID("ThousandCragMyriadRavine");
