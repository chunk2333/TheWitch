...
public class ElementPotions extends AbstractPotion {
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(TheWitch.makeID("ElementPotions"));

    public static final String POTION_ID = TheWitch.makeID("ElementPotions");
