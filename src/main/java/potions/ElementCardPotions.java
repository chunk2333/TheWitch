...
public class ElementCardPotions extends AbstractPotion {
    ...
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(TheWitch.makeID("ElementCardPotions"));

    public static final String POTION_ID = TheWitch.makeID("ElementCardPotions");
