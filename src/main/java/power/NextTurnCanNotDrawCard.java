...
public class NextTurnCanNotDrawCard extends AbstractPower {
    public static final String POWER_ID = TheWitch.makeID("NextTurnCanNotDrawCard");

    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(TheWitch.makeID("NextTurnCanNotDrawCard"));
